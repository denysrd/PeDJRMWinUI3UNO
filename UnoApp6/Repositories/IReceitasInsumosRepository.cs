...
{       
    ...
    Task<bool> DeleteByVersaoReceitaIdAsync(int versaoReceitaId); // Remove um insumo de receita pelo ID
    Task<bool> DeleteByReceitaIdAsync(int receitaId); // Remove um insumo de receita pelo ID
}
